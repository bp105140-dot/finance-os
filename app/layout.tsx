      ...
      >
        ...
        >
          <div className="flex items-center justify-between w-full md:w-auto gap-4">
            ...
            {/* --- ÁREA DO LOGO E NOME ALTERADA AQUI --- */}
            <div className="flex items-center gap-3">
              <a 
                href="https://devlabzz.com.br/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-indigo-600 p-2 md:p-2.5 rounded-xl md:rounded-2xl text-white shadow-lg hover:scale-105 hover:bg-indigo-700 transition-all cursor-pointer"
                title="Visitar DevLabzz"
              >
                <Zap size={18} fill="currentColor" />
              </a>
              <div className="flex flex-col">
                <h1 className="text-base md:text-xl font-black tracking-tighter italic uppercase flex items-center gap-1.5">
                  {userConfig.nome} <span className="text-indigo-600">{userConfig.emoji}</span>
                </h1>
                <a 
                  href="https://devlabzz.com.br/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] hover:text-indigo-500 transition-colors mt-0.5"
                  title="Visitar DevLabzz"
                >
                  BY DEVLABZZ
                </a>
